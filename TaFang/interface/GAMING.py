...
class GAMING():
	...
	def drawToolbar(self, screen):
		...
		scoreInfo = self.info_font.render('Score: ' + str(self.score), True, white)  # 显示分数信息
		...
		screen.blit(scoreInfo, (self.leftinfo_rect.left + 5, self.leftinfo_rect.top + 75))  # 将分数信息绘制到界面
		# 右侧和中间的其他显示
